...
describe("TonAttestationService", () => {
    ...
    it("should attest transfer executed event", async () => {
        const mockTx = loadTransaction(
            Cell.fromBase64('').beginParse()
        );
        ...
        expect(msg.output.currency).toBe("EQCPCNJo1kfIutVC_VDrov-3TfbwreJDMUtfRA7NxGlrZntT");
        expect(msg.output.amount).toBe("100000000");
        expect(msg.output.id).toBe("73323063728733591395919464998198581475502595201385602055113536612744798501287");
    });
